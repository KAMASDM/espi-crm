    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="md:col-span-2">
            ...
            <input
              type="text"
              {...register('univ_name', { required: 'University name is required' })}
              className="input-field"
            />
            {errors.univ_name && (
              <p className="text-red-600 text-sm mt-1">{errors.univ_name.message}</p>
            )}
          </div>
      ...
      <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200">
        ...
        <button
          ...
          disabled={loading}
        >
          {loading ? 'Saving...' : editData ? 'Update University' : 'Create University'}
        </button>
      </div>
    </form>
  );
