      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600">
            Comprehensive insights into your education consultancy performance
          </p>
        </div>
                  ...
                  >
                    ...
                    <div className="text-right">
                      <p className="text-sm font-medium text-green-600">
                        {uni.admissions} admitted
                      </p>
                      <p className="text-xs text-gray-500">
                        {Math.round((uni.admissions / uni.applications) * 100)}%
                        success
                      </p>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="card">
              ...
              <div className="space-y-4">
                {[
                  {
                    stage: "Enquiry to Assessment",
                    time: "2.3 days",
                    status: "good",
                  },
                  {
                    stage: "Assessment to Application",
                    time: "5.1 days",
                    status: "average",
                  },
                  {
                    stage: "Application to Admission",
                    time: "18.5 days",
                    status: "good",
                  },
                  {
                    stage: "Admission to Visa",
                    time: "12.2 days",
                    status: "average",
                  },
                ].map((item) => (
